#!/bin/bash
set -e
# Auto-generated: 2026-03-19 22:10:10
# Device: cpu | Runs: 12
...
# === Run 3/12: P1 | EUR | hybrid_two_stage     | 2024-12-09 → 2024-12-10 ===
echo ''
echo '============================================'
echo 'Run 3/12: P1 | EUR | hybrid_two_stage     | 2024-12-09 → 2024-12-10'
echo '============================================'
RUN_START=$(date +%s)
mkdir -p results/eur/phase1_modes/hybrid_two_stage/2024-12-09
cd $BASEDIR
python results/_run_003.py 2>&1 | tee results/eur/phase1_modes/hybrid_two_stage/2024-12-09/log.txt
...
# === Run 4/12: P1 | EUR | hybrid_two_stage     | 2025-12-08 → 2025-12-09 ===
echo ''
echo '============================================'
echo 'Run 4/12: P1 | EUR | hybrid_two_stage     | 2025-12-08 → 2025-12-09'
echo '============================================'
RUN_START=$(date +%s)
mkdir -p results/eur/phase1_modes/hybrid_two_stage/2025-12-08
cd $BASEDIR
python results/_run_004.py 2>&1 | tee results/eur/phase1_modes/hybrid_two_stage/2025-12-08/log.txt
...
# === Run 5/12: P2 | USD | roughness           | 2024-12-09 ===
echo ''
echo '============================================'
echo 'Run 5/12: P2 | USD | roughness           | 2024-12-09'
echo '============================================'
RUN_START=$(date +%s)
mkdir -p results/usd/phase2_roughness/roughness/2024-12-09
cd $BASEDIR
python results/_run_005.py 2>&1 | tee results/usd/phase2_roughness/roughness/2024-12-09/log.txt
...
# === Run 6/12: P2 | USD | roughness           | 2025-12-08 ===
echo ''
echo '============================================'
echo 'Run 6/12: P2 | USD | roughness           | 2025-12-08'
echo '============================================'
RUN_START=$(date +%s)
mkdir -p results/usd/phase2_roughness/roughness/2025-12-08
cd $BASEDIR
python results/_run_006.py 2>&1 | tee results/usd/phase2_roughness/roughness/2025-12-08/log.txt
...
# === Run 7/12: P2 | USD | cross                | 2024-12-09 ===
echo ''
echo '============================================'
echo 'Run 7/12: P2 | USD | cross                | 2024-12-09'
echo '============================================'
RUN_START=$(date +%s)
mkdir -p results/usd/phase2_cross/cross/2024-12-09
cd $BASEDIR
python results/_run_007.py 2>&1 | tee results/usd/phase2_cross/cross/2024-12-09/log.txt
...
# === Run 8/12: P2 | USD | cross                | 2025-12-08 ===
echo ''
echo '============================================'
echo 'Run 8/12: P2 | USD | cross                | 2025-12-08'
echo '============================================'
RUN_START=$(date +%s)
mkdir -p results/usd/phase2_cross/cross/2025-12-08
cd $BASEDIR
python results/_run_008.py 2>&1 | tee results/usd/phase2_cross/cross/2025-12-08/log.txt
...
# === Run 9/12: P2 | EUR | roughness           | 2024-12-09 ===
echo ''
echo '============================================'
echo 'Run 9/12: P2 | EUR | roughness           | 2024-12-09'
echo '============================================'
RUN_START=$(date +%s)
mkdir -p results/eur/phase2_roughness/roughness/2024-12-09
cd $BASEDIR
python results/_run_009.py 2>&1 | tee results/eur/phase2_roughness/roughness/2024-12-09/log.txt
...
# === Run 10/12: P2 | EUR | roughness           | 2025-12-08 ===
echo ''
echo '============================================'
echo 'Run 10/12: P2 | EUR | roughness           | 2025-12-08'
echo '============================================'
RUN_START=$(date +%s)
mkdir -p results/eur/phase2_roughness/roughness/2025-12-08
cd $BASEDIR
python results/_run_010.py 2>&1 | tee results/eur/phase2_roughness/roughness/2025-12-08/log.txt
...
# === Run 11/12: P2 | EUR | cross                | 2024-12-09 ===
echo ''
echo '============================================'
echo 'Run 11/12: P2 | EUR | cross                | 2024-12-09'
echo '============================================'
RUN_START=$(date +%s)
mkdir -p results/eur/phase2_cross/cross/2024-12-09
cd $BASEDIR
python results/_run_011.py 2>&1 | tee results/eur/phase2_cross/cross/2024-12-09/log.txt
...
# === Run 12/12: P2 | EUR | cross                | 2025-12-08 ===
echo ''
echo '============================================'
echo 'Run 12/12: P2 | EUR | cross                | 2025-12-08'
echo '============================================'
RUN_START=$(date +%s)
mkdir -p results/eur/phase2_cross/cross/2025-12-08
cd $BASEDIR
python results/_run_012.py 2>&1 | tee results/eur/phase2_cross/cross/2025-12-08/log.txt
